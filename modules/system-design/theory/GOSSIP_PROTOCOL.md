...
Аналог сплетен в толпе: «слух» расходится экспоненциально. Каждый раунд узел знает информацию → следующий раунд знают ещё N (с peers он обменялся).
...
Узел шлёт **свою** информацию соседям. Peer обновляет свою копию если новее.
