...
Таблица «сколько что стоит» — основа capacity planning и архитектурных решений. Jeff Dean популяризовал в 2009; цифры обновляются под современное железо (SSD, NVMe, fast NIC).
...
## Powers of two (для capacity estimation)
...
## QPS / TPS ranges (по типам системам)
