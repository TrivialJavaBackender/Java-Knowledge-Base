...
## 1. L1 — кэш первого уровня (persistence context)
...
## 2. L2 — кэш второго уровня (shared cache)
...
## 3. Стратегии параллельного доступа к кэшу (Cache Concurrency Strategies)
...
## 5. Чем кэш Hibernate отличается от Spring `@Cacheable`
