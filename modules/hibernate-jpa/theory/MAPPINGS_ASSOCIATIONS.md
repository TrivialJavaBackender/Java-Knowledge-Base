...
## 2. `@Embeddable` / `@Embedded` — компонентный маппинг
...
## 4. Владеющая сторона и обратная сторона: роль `mappedBy`
...
## 8. equals / hashCode для сущностей
