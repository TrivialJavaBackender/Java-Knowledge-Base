...
## equals / hashCode для класса ключа — почему обязательны
...
## Производные идентификаторы — `@MapsId`
...
## Battle-story: потерянная строка из-за забытого equals
