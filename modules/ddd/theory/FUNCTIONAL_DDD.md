...
## 1. Сделать невалидные состояния непредставимыми (make illegal states unrepresentable)
...
## 2. Алгебраические типы данных: product и sum
...
## 3. Функциональное ядро, императивная оболочка (functional core / imperative shell)
...
## 4. Неизменяемость домена и обновление через copy
...
## 5. Result/Either вместо исключений: тотальные функции
...
## 6. Parse, don't validate: smart constructor
