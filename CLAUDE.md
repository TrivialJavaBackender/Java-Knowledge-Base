...
файл открывается ответами «какую проблему решает / кому это надо / когда НЕ надо»; раздел строится
как «задача → наивное решение и где ломается → механизм → правило»; каждое утверждение о поведении
подпёрто исходником с номером строки, прогоном или спецификацией. Ниже — только технический формат.
